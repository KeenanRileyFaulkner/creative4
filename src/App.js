    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<BaseComponent authed={authed} login={login} logout={logout} />}>
          <Route path="about" element={<><NavBar titleLinkName='music-player' /><AboutContent /><Footer /></>} />
          <Route path="music-player" element={<><NavBar titleLinkName='covers-player' /><PlayerContent /><Footer /></>} />
          <Route path="covers-player" element={<><NavBar titleLinkName='about' /><CoversContent /><Footer /></>} />
